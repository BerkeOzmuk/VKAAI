...
"""
	Na een heleboel verschillende configuraties zijn we uitendelijk tot deze gekomen.
	Als eerste gaat alles door een convolutie laag met 30 filters en een maxpooling laag.
	Dit wordt hierna nog 2 keer gedaan maar dan met 60 en 120 filters.
	Als laatste gaat het door een convolutie laag van 10 filters om zoals in de uitleg verteld is de output klaar te maken voor opdracht D.
"""
...
"""
	...
	Conv2D          (None, 26, 26, 30)
	MaxPooling2D    (None, 13, 13, 30)
	Conv2D          (None, 11, 11, 60)
	MaxPooling2D    (None, 5, 5, 60)
	Conv2D          (None, 3, 3, 120)
	MaxPooling2D    (None, 1, 1, 120)
	Conv2D          (None, 1, 1, 10)
"""
...
"""
	LAYER           PARAM   BEREKENING

	Conv2D          300     300 = (30 * (3 * 3 * 1 + 1)
	MaxPooling2D    0       x
	Conv2D          16260   16260 = (60 * (3 * 3 * 30 + 1)
	MaxPooling2D    0       x
	Conv2D          64920   64920 = (120 * (3 * 3 * 60 + 1)
	MaxPooling2D    0       x
	Conv2D          1210    1210 = (10 * (1 * 1 * 120 + 1)
"""
...
"""
	...
	Conv2D          20310 = (30 * (26 * 26 * 30 + 1)
	MaxPooling2D    x
	Conv2D          435660 = (60 * (11 * 11 * 60 + 1)
	MaxPooling2D    x
	Conv2D          129720 = (120 * (3 * 3 * 120 + 1)
	MaxPooling2D    x
	Conv2D          110 = (10 * (1 * 1 * 10 + 1)
"""
