...
"""
	Na wat online onderzoek te doen naar convolution layers en heel veel trial en error blijkt deze configuratie goed genoeg te werken om bij een accuracy van 0,97 te komen.
	Eerst gaat alles door een convolutie laag en maxPooling laag om alle features te extracten.
	Daarna gaat het door een flatten layer om uit eindelijk door de dense laag heen te gaan.
	Maar voordat dat gebeurt gaat het eerst nog door een dropout laag om overfitting te voorkomen.
"""
...
"""
	...
	Conv2D		320	320 = (32 * (3 * 3 * 1 + 1)
	MaxPooling2D	0	x
	Flatten		0	x
	Dropout		0	x
	Dense		54090	54090 = (5408 * 10 + 10)
"""
